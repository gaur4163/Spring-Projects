		...
		<div class="row">
			<div class="col-lg-9 col-md-12">
				<div class="row">
					...
					<form class="form-horizontal" action="bookProperty" method="post">
					<input type = "hidden" value = "${property.getPropertyId()}" name = "propertySearchId"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="number" name="bookingAmount" id="bookingAmount" min="500" max="10000"  id="bookingAmount" class="form-control" required="required" />
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-9 col-sm-offset-3">
								<p class="text-center">
							<input type="submit" value="Book"  class="btn btn-danger" role="button"/>
						</p>
							</div>
						</div>
						<!-- <div class="form-group">
							<div class="col-sm-9 col-sm-offset-3">
								<p class="text-center">
							<input type="submit" value="MessageToSeller"  class="btn btn-danger" role="button"/>
						</p>
							</div>
						</div> -->
					...
					<form action = "usermsgScreen" method="post" >
                         <input type="hidden" name = "msgToObj" value = "${requestScope.property.user.userId}"/>
                         <input type = "submit" class="btn btn-primary"  value="Messages"  />
