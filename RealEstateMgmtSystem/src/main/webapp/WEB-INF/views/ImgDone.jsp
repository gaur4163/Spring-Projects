		   ...
		   <div class="row">
				...
				<div class="account-wall">
					<h3 class="text-center">Property Saved</h3>
						...
						<p class="text-center"><input type = "submit" value = "Add Images" class="btn btn-primary btn-block"/>
						</div>
						<div class="col-sm-9 col-sm-offset-3">
								<!-- <input type="button" value="skip" class="btn btn-primary btn-block"/> -->
								<p class="text-center"><a href="home" class="btn btn-primary btn-block" role="button">Done</a></p>
						</div>
						</form>
